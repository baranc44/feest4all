    ...
    <div style="max-width: 110rem;" class="mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-jet-dropdown align="right" width="48" class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-slot name="trigger">
                        <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                            <div>Kilometerregistratie</div>
                            <div class="ml-1">
                    ...
                    <x-slot name="content">
                        <x-jet-dropdown-link href="{{ route('kmdashboard') }}">
                        <div class="block px-4 py-2 text-l text-gray-400">
                            {{__("Home")}}
                        </div>
                        </x-jet-dropdown-link>
